enunt = {
    "problema" : '''Se dau n numere naturale. Să se determine ultimul număr par dintre cele date. Dacă nu au
fost citite numere pare, se va afişa doar mesajul IMPOSIBIL.''',
    "solutie" : ''' ''' 
}
